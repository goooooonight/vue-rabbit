...
var D = (function () {
  ...
  return (
    ...
    (r.prototype.setAlpha = function (t) {
      return (
        (this.a = A(t)), (this.roundA = Math.round(100 * this.a) / 100), this
      )
    }),
    ...
    (r.prototype.toName = function () {
      ...
      for (
        var t = '#' + k(this.r, this.g, this.b, !1),
          e = 0,
          a = Object.entries(x);
        e < a.length;
        e++
    ...
    (r.prototype.monochromatic = function (t) {
      t === void 0 && (t = 6)
      for (
        var e = this.toHsv(), a = e.h, n = e.s, i = e.v, f = [], s = 1 / t;
        t--;
    ...
    (r.prototype.polyad = function (t) {
      for (
        var e = this.toHsl(), a = e.h, n = [this], i = 360 / t, f = 1;
        f < t;
        f++
      )
